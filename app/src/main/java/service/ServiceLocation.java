...
public class ServiceLocation extends Service
{
    ...
    private void updateLocation(boolean isEnCours)
    {
        ...
        if (isEnCours)
        {
            if (Build.VERSION.SDK_INT > 28)
            {
                ...
                {
                    request = new LocationEngineRequest.Builder(1000).setPriority(LocationEngineRequest.PRIORITY_HIGH_ACCURACY).setMaxWaitTime(5000).build();
                }
    ...
    private void commencerService()
    {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, CANAL_ID).setAutoCancel(false).setOngoing(true).setSmallIcon(R.mipmap.icon_mapan_round).setContentTitle("Enregistrement en cours").setContentText("00:00:00").setContentIntent(pendingIntent);
